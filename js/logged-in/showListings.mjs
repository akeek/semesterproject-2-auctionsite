export function showListingsLoggedIn(allListings) {
          ...
          <div class="col p-3">
                <div class="card h-100 border-0 bg-light">
                  ...
                  <hr>
                    ...
                    <a href="/listing.html?id=${allListings[i].id}"><button class="btn btn-secondary px-4 mb-2"><strong>Bid now</strong></button></a>
                    </div>
                </div>
              </div>
          `;
