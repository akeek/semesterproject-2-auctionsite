        ...
        listingsContainer.innerHTML += `
          <div class="col p-2">
                  <div class="card h-100 border-1 bg-light border-0 ">
                      <a href="/listing.html?id=${myListings[i].id}"><img src="${myListings[i].media[0]}" class="card-img-top" style="height: 15rem; object-fit: cover" alt="Image caption: ${myListings[i].title}"></a>
                      <div class="card-body">
                      ...
                      <a href="/listing.html?id=${myListings[i].id}"><button class="btn btn-primary px-4 mb-2"><strong>Open</strong></button></a>
                      </div>
                  </div>
                  </div>
